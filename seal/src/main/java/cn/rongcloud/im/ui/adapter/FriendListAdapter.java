...
public class FriendListAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public static final int ADAPTER_DATA_TYPE1 = 1;
    public static final int ADAPTER_DATA_TYPE2 = 2;

    public FriendListAdapter(Context context, List<Friend> list,int type) {
