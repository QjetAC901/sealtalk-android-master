...
public class MyAccountActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (!TextUtils.isEmpty(cacheName)) {
            ...
            String portraitUri = SealUserInfoManager.getInstance().getPortraitUri(new UserInfo(cacheId, cacheName, Uri.parse(cachePortrait)));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rl_my_portrait:
                showPhotoDialog();
                break;
            case R.id.rl_my_username://更改Name
    ...
    public void onSuccess(int requestCode, Object result) {
        if (result != null) {
            switch (requestCode) {
                case UP_LOAD_PORTRAIT://头像网络同步成功
                    ...
                    break;
                case GET_QI_NIU_TOKEN://Token网络同步成功
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case PhotoUtils.INTENT_CROP://截图
            case PhotoUtils.INTENT_TAKE://拍照
            case PhotoUtils.INTENT_SELECT://图库选择图片
